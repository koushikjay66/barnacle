    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Music Videos</h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="glyphicon glyphicon-stats"></i> Publish and control music videos on YouTube
                            </li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                ...
                <div class="col-lg-12">                
                    <div class="panel panel-primary" id="publishnews">                    
                        <div class="panel-heading">
                            <h3 class="panel-title center-block">Publish a Music Video</h3>
                        </div>
                        <div class="panel-body">
                            <form role="form" action="#" method="post">
                                <fieldset>
                                    <div class="form-group">
                                    <input class="form-control" placeholder="YouTube Link" name="youtubelink" type="url" autofocus required>
                                    </div>
                                    <div class="form-group">
                                    <input class="form-control" placeholder="Video Title" name="videotitle" required>
                                    </div>
                                    <input type="submit" name="publishmv" value="Publish Music Video" id="submit" class="btn btn-default btn-primary btn-block">
                                </fieldset>
                            </form>
                        </div>
                        </div>
                ...
                <div class="col-lg-12">                
                    <div class="panel panel-info" id="publishnews">                    
                        <div class="panel-heading">
                            <h3 class="panel-title center-block">Previously published Music Videos</h3>
                        </div>
                        <div class="panel-body">
