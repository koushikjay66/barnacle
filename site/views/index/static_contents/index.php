                ...
                <div id="register_div" style="display: none;">
                    <div class="register-screen" id="register-screen">
                        ...
                        <div class="register-form">
                            <form name="sugnup_form" action="http://barnacle.koushikjay.me/join/signup" method="POST">

                                <div class="control-group">
                                    <input type="text" class="login-field" value="" placeholder="firstname" id="login-name" name="f_name">
                                    <label class="login-field-icon fui-user" for="login-name"></label>
                                </div>
                                <div class="control-group">
                                    <input type="text" class="login-field" value="" placeholder="lastname" id="login-name" name="l_name">
                                </div>
                                <div class="control-group">
                                    <input type="email" class="login-field" value="" placeholder="Email" id="login-name" name="u_email">
                                </div>
                                <div class="control-group">
                                    <input type="text" class="login-field" value="" placeholder="User Name" id="login-name" name="u_name">
                                </div>
                                <div class="control-group">
                                    <input type="password" class="login-field" value="" placeholder="password" id="login-name" name="u_password">
                                </div>
                                <div class="control-group">
                                    <input type="password" class="login-field" value="" placeholder="confirm password" id="login-name">
                                </div>

                                <input type="submit" class="btn btn-primary btn-large btn-block" name="signup">register</a>
                            </form>
                        </div>
